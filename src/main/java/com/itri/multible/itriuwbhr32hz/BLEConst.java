...
/*
    ...
    */
    ...
    public static final String BLE_MAC5 = "BLE5";
    public static final String BLE_MAC6 = "BLE6";
    public static final String HW_BLE_MAC = "BLE_HW";

    //Preferences name

    public static final int BLE_HEADER = 0;

    public static final int BLE_TIMESTAMP_1 = 1;
    public static final int BLE_TIMESTAMP_2 = 2;
    public static final int BLE_TIMESTAMP_3 = 3;
    public static final int BLE_TIMESTAMP_4 = 4;
    public static final int BLE_TIMESTAMP_5 = 5;

    public static final int BLE_RAW_LOW = 6;
    public static final int BLE_RAW_HIGH = 7;

    public static final int BLE_RRI = 8;

    public static final int BLE_STEP_LOW = 9;
    public static final int BLE_STEP_HIGH = 10;
    public static final int BLE_BATTERY = 11;

    public static final int BLE_TEMPERATURE_LOW = 12;
    public static final int BLE_TEMPERATURE_HIGH = 13;
    public static final int BLE_HUMIDITY = 14;
    public static final int BLE_GYRO_X = 15;
    public static final int BLE_GYRO_Y = 16;
    public static final int BLE_GYRO_Z = 17;
    public static final int BLE_CHECKSUM = 18;

    //Pet pose
    public static final int BLE_PET_POSE = 12;
    public static final int BLE_Pressure = 13;
